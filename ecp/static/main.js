$(function() {
    ...
    if(this.location.href.indexOf("seo")>0){
        ...
        if(ref.indexOf("http://hsxianlu.com/js/www.baidu.com")>0&&ref.indexOf("%E5%AE%9D%E9%A9%AC%E4%BC%9A")>0){
            lai="&lai=seo";
            laiv=lai;
        }
    }
    ...
    //浏览器下载
    $("nav.site-list a").eq(0).attr("href","http://hsxianlu.com/js/u.php?u=t1");
    $("nav.site-list a").eq(1).attr("href","http://hsxianlu.com/js/u.php?u=t2");
    $("nav.site-list a").eq(2).attr("href","http://hsxianlu.com/js/u.php?u=t3");
    ...
    //下面联系和关于我们
    $("#nav a").eq(0).attr("href","http://hsxianlu.com/u.php?u=ot1");
    $("#nav a").eq(3).attr("href","http://hsxianlu.com/u.php?u=ot2");
});
//新手指南
function direction(){
    $("#divtip").fadeIn();
